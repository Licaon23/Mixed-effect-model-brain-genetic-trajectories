...
geneticData <- readRDS(here(cleandataDir,"geneticData.RDS"))
...
### Polygenic risk scores and SNPs               ### -------------------------
demo <- merge(demo,geneticData,by="PTID",all.x=T)
...
codebook$description <- c("Patient identification number",
                          ...
                          rep("",2),
                          rep("Number of effect allelles for a given SNP",10),
