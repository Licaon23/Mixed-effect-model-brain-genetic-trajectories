...
# =============================================================================
volVar <- sort(names(dd)[33:45]) # variables volums
...
ggplot(numMeasures_long_prop,aes(x=VISCODE2, y=propMeasures,group=DX.bl)) +
  ...
  geom_hline(yintercept = 0.05,linetype="dotted",col="red4")+
  ...
  labs(subtitle = "<span style = 'color: #1B9E77;'>**Controls**</span>, <span style = 'color: #D95F02;'>**Mild cognitive impairment**</span> and <span style = 'color: #7570B3;'>**Alzheimer`s disease**</span>" ,
       caption="**Source**: ADNI project | **Units** Proportion of available measurements at each visit with respect to total number of pacients per group. Time after baseline visit<br/>in months. Annotations are number of patients who underwent MRI session at a given visit after baseline.") +
